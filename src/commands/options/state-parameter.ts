...
class StateParameter extends StringParameter {
  /**
...
// Exports
export const OptionalStateParameter = new StateParameter();
export const RequiredStateParameter = new StateParameter(true);
