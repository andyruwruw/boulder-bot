...
import RouteAttemptCommand from './routes/route-attempt-command';
import CragCommand from './crags/crag-command';
import RouteCommand from './routes/route-command';
import SessionCommand from './sessions/sessions-command';
...
export class CommandManager {
  ...
  static instantiateCommands() {
    // // General Commands
    CommandManager._commands[RouteAttemptCommand.key] = new RouteAttemptCommand();
    CommandManager._commands[CragCommand.key] = new CragCommand();
    CommandManager._commands[RouteCommand.key] = new RouteCommand();
    CommandManager._commands[SessionCommand.key] = new SessionCommand();
    CommandManager._commands[WeatherCommand.key] = new WeatherCommand();
  }
