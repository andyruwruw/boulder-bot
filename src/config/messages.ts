...
/**
 * Error message thrown when abstract web scrapper is used.
 */
export const MESSAGE_USED_ABSTRACT_WEB_SCRAPPER_ERROR = 'Attempted to use Abstract Web Scrapper, use a concrete implementation instead.';
